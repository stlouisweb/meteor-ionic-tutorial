...
**client/includes/** will contain contain files that will be used throughout our app, and views will contain files contain files that are specific to certain views or pages of the app.
